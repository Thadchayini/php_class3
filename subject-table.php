    ...
    <body>
        ...
        ?>
            <tr style="background-color:<?php echo $row['subject_color'];?>">
                ...
                <td><a href="subject-edit.php?id=<?php echo $row['id'];?>">Edit</a></td>
                <td><a href="subject-delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Do You want to Delete?')">Delete</a></td>
            </tr>
        <?php
            }
        ?>
